...
<html lang="ko" data-visual-system="radar-unified-v2" data-visual-surface="report" data-visual-page="spike-report">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        :root {
            ...
            --radar-bg2:#171613;
            --radar-panel:#1d211f;
            --radar-panel2:rgba(244, 242, 234, .06);
        ...
        .alert-box {
            background: linear-gradient(135deg, rgba(239,99,81,.28), rgba(242,193,78,.20));
            border: 1px solid rgba(239,99,81,.32);
            border-radius: 8px;
            color: var(--radar-text);
        }
        .section-title {
        ...
        .spike-card {
            background: var(--radar-panel2);
            border-left-color: var(--radar-danger);
            border-radius: 8px;
        }
        .keyword-name {
            color: var(--radar-text);
        ...
        .insight {
            ...
            border-left-color: var(--radar-accent);
        }
        .no-data,
        .footer {
